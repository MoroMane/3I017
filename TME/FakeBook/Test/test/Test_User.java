...
public class Test_User
{
	...
	{
		System.out.println("Create user: "+servicesClasses.User.CreateUser("3408748","monmdp","Fabien","Tang"));
		System.out.println("Create user: "+servicesClasses.User.CreateUser("1234567","deagle","Juan","Montoya"));
		System.out.println("Delete user: "+servicesClasses.User.DeleteUser("1234567"));
		System.out.println("----------------------------");		
