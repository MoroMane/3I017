...
public class Message 
{
	...
	public static BasicDBObject ListMessage(String key, List<String> users)throws JSONException, UnknownHostException
	{
		return bd.MessageTools.ListMessage(key,users);
	}
}